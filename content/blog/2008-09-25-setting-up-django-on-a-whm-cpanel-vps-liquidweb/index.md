...
[highly recommend them](/blog/liquidweb-rocks)!
...
![cPanel Databases](./images/image2.png)
...
![Apache Setup](./images/image3.png)

`LoadModule wsgi_module /usr/lib/httpd/modules/mod_wsgi.so `

AddHandler wsgi-script .wsgi

[Add Handler](./images/image4.png)
...
my `./configure` command said it found Apache 2.2.9. I asked LiquidWeb Support
and they said that it was likely because I needed FastCGI installed.
...
![cPanel Subdomains](./images/image5.png)
