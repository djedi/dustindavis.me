...
[bash] sudo pip install virtualenv virtualenvwrapper echo "" >> .bashrc echo
...
/var/log/supervisor/celeryd_err.log [/text]

Now we will create CeleryCam in /etc/supervisor/conf.d/celerycam.conf

[bash] sudo vim /etc/supervisor/conf.d/celerycam.conf [/bash]

Contents:

[text] [program:celerycam] command =
...
/var/log/supervisor/celerycam_err.log [/text]

Create Gunicorn script in /etc/supervisor/conf.d/gunicorn.conf

[bash] sudo vim /etc/supervisor/conf.d/gunicorn.conf [/bash]

Contents:

[text] [program:gunicorn] command =
/home/username/.virtualenvs/project_env/bin/python
...
/var/log/supervisor/gunicorn_err.log [/text]
