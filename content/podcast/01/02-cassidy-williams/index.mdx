...
number: 2
keywords: null
metaImage: './cassidy-williams-card.png'
guestPhoto: './cassidy-williams.png'
---
...
import cassidyPhoto from './cassidy-williams.png'
...
<Guest name="Cassidy Williams" image={cassidyPhoto}>
